...
declare namespace Registry {
    ...
    class Arithmetic extends Internal.RegistryEventJS<any> {
    }
    class IotaType extends Internal.RegistryEventJS<any> {
    }
    class EvalSound extends Internal.RegistryEventJS<any> {
    }
    class ContinuationType extends Internal.RegistryEventJS<any> {
    }
    class SpecialHandler extends Internal.RegistryEventJS<any> {
    }
    class Action extends Internal.RegistryEventJS<any> {
    }
    ...
    class PocketUpgradeSerialiser extends Internal.RegistryEventJS<any> {
    }
    class TurtleUpgradeSerialiser extends Internal.RegistryEventJS<any> {
    }
    ...
    class RatVariant extends Internal.RegistryEventJS<any> {
    }
