...
tags(type: "hexcasting:action", handler: (event: TagEvent.Action) => void): void
...
registry(type: "hexcasting:arithmetic", handler: (event: Registry.Arithmetic) => void):void,
registry(type: "hexcasting:iota_type", handler: (event: Registry.IotaType) => void):void,
registry(type: "hexcasting:eval_sound", handler: (event: Registry.EvalSound) => void):void,
registry(type: "hexcasting:continuation_type", handler: (event: Registry.ContinuationType) => void):void,
registry(type: "hexcasting:special_handler", handler: (event: Registry.SpecialHandler) => void):void,
registry(type: "hexcasting:action", handler: (event: Registry.Action) => void):void,
...
registry(type: "computercraft:pocket_upgrade_serialiser", handler: (event: Registry.PocketUpgradeSerialiser) => void):void,
registry(type: "computercraft:turtle_upgrade_serialiser", handler: (event: Registry.TurtleUpgradeSerialiser) => void):void,
...
registry(type: "rats:rat_variant", handler: (event: Registry.RatVariant) => void):void,
