...
declare namespace TagEvent {
    ...
    class RatVariant extends Internal.TagEventJS {
    get(id: Special.RatVariantTag): Internal.TagWrapper
    add(tag: Special.RatVariantTag, ...id: Special.RatVariant[]): Internal.TagWrapper
    remove(tag: Special.RatVariantTag, ...id: Special.RatVariant[]): Internal.TagWrapper
    removeAll(tag: Special.RatVariantTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.RatVariant[]): Internal.TagWrapper
    }
